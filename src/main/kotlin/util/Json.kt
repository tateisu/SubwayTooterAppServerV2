...
private val reNumber = """-?(?:0|[1-9][0-9]*)(?:\.[0-9]+)?(?:[eE][+-]?[0-9]+)?""".toRegex()
...
inline fun buildJsonObject(initializer: JsonObject.() -> Unit) =
    JsonObject().apply { initializer() }

inline fun buildJsonArray(initializer: JsonArray.() -> Unit) =
